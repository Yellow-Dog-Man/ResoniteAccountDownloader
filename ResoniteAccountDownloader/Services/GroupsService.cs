...
namespace ResoniteAccountDownloader.Services
{
    public class GroupRecord : ReactiveObject, IGroup
    {
        ...
        public long UsedBytes => Storage.UsedBytes;

        public long QuotaBytes => Storage.TotalBytes;
    ...
    public class GroupsService : IGroupsService
    {
        ...
        public async Task<List<IGroup>> GetGroups()
        {
            ...
            var memberships = await Interface.Groups.GetUserGroupMemeberships();
            ...
            {
                var group = await Interface.Groups.GetGroup(membership.GroupId);
